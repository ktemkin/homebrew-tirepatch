class Rust < Formula
  ...
  stable do
    ...
    version "2020-11-19"
    sha256 "8b192ad45c9208b16ebb363e207669ff2a26c490bef214124232cf79e8c4e170"
  ...
  resource "cargobootstrap" do
    on_macos do
      ...
      url "https://static.rust-lang.org/dist/2020-10-16/cargo-nightly-aarch64-apple-darwin.tar.gz"
      sha256 "e2aa65e31489f7caf3d6bb18f3cdc87795228a2e5e68baeb8b7f35d14c3e41e9"
    end
  ...
  def install
    ...
    inreplace "src/stage0.txt" do |s|
      s.gsub! /beta/, "nightly"
      s.gsub! /2020-10-16/, "2020-11-16"
      s.gsub! /.*nightly-2020-10-12.*/, ""
    end
